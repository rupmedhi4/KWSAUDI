...
WORTH GIVING, AND LEGACIES WORTH LEAVING.`,
    ...
    },
    {
      ...
      title: 'OUR VISION',
      text: 'TO BE THE REAL ESTATE COMPANY OF CHOICE FOR AGENTS AND THEIR CUSTOMERS.',
    },
    {
  ...
  const teamMembers = [
    {
      ...
      image: "https://static.wixstatic.com/media/36a881_c32aecbd35de48f1839a4c8b90be6196~mv2.jpg/v1/fill/w_365,h_365,fp_0.46_0.15,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/Pic48_edited.jpg",
    },
    {
      name: "HAIFA SDIRI",
      title: "REGIONAL MCA",
      ...
      image: "https://static.wixstatic.com/media/36a881_1d8efa05d1da4efcbcdcfd4a99921c79~mv2.png/v1/fill/w_365,h_365,fp_0.49_0.23,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Haifa%20Sdiri.png",
    },
    {
    ...
    },
    {
      ...
      image: "https://static.wixstatic.com/media/36a881_e0f85e7b86444035b1f97950b5574a74~mv2.png/v1/fill/w_365,h_365,fp_0.51_0.24,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Alaa%20Moftah.png",
    },
    {
      name: "AYAN HASSAN",
    ...
    },
    {
      ...
      image: "https://static.wixstatic.com/media/36a881_da8c9c2ce26a4f6bb8c54774c402735f~mv2.png/v1/fill/w_365,h_365,fp_0.49_0.22,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Osama%20Hamza.png",
    },
  ];
    ...
    <div className="relative">
      ...
      <main className="px-4 mt-10">
        <div className="mx-auto text-center">
          ...
          <div className="mt-10">
            ...
            >
              We believe that the company we keep can contribute to our lives in untold ways. To help cement this understanding we've formalized a
            </p>
          ...
          {cards.slice(0, 3).map((card, index) => (
            ...
            >
              ...
              <div className="group-hover:-translate-y-2 transition-transform duration-300 ease-in-out">
                ...
                <p className="text-base leading-5 tracking-wide uppercase text-neutral-600 whitespace-pre-line">
                  {card.text}
                </p>
              </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-stretch gap-6">
          {cards.slice(3).map((card, index) => (
            ...
            >
              ...
              <div className="group-hover:-translate-y-2 transition-transform duration-300 ease-in-out">
                <h3 className="mb-4 text-lg font-semibold tracking-wide line-clamp-2">
                  {card.title}
                </h3>
              </div>
              <div className="flex-1 overflow-y-auto w-full group-hover:-translate-y-2 transition-transform duration-300 ease-in-out">
                <p className="text-base leading-5 text-neutral-600 whitespace-pre-line">
                  {card.text}
                </p>
              </div>
            </div>
      ...
      <div className="min-h-screen flex flex-col items-center justify-start pt-10 md:pt-10">
        <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start items-center text-center mt-8 md:mt-12 px-2 md:px-10">
            ...
            <h2 className="text-red-800 mt-14 text-lg font-semibold tracking-wider">
              CEO MESSAGE
            </h2>
            <p className="mt-4 text-base text-gray-700 leading-6 max-w-md">
              More than ever, we want to thank and recognize our agents and partners for diligently bringing their very
            </p>
            <p className="text-base text-gray-700 leading-6 max-w-md">
              best when their clients need it most. As a company built by agents, and for agents, we wake up every day
            </p>
            <p className="text-base text-gray-700 leading-6 max-w-md">
              asking ourselves how we can best support them.
            </p>
            <p className="mt-6 text-base text-gray-700 leading-4 max-w-md">
            ...
            <p className="text-base text-gray-700 leading-6 max-w-md">
              agent partners. No one succeeds alone, and
            </p>
            <p className="text-base text-gray-700 leading-6 max-w-md">
              this is truly a shared moment in recognition of our continuous achievements together.
            </p>
          </div>
        </div>
      </div>
      <div className="min-h-screen bg-white mt-20">
        <div className="flex flex-col md:flex-row border-t border-b border-r border-black">
          <div className="w-full md:w-1/2 flex justify-center items-center md:sticky md:top-0 top-20 h-auto md:h-screen border-b md:border-b-0 md:border-r border-black py-10 md:py-0">
            <div className="text-center px-4">
              ...
              <p className="text-base tracking-wider mt-4 md:mt-10">REGION TEAM</p>
            </div>
          </div>
              ...
              <div key={index}>
                <div className="flex flex-col md:flex-row gap-6 p-6">
                  ...
                  <div className="pt-2 text-center md:text-left">
                    <p
                      style={{
                        fontFamily: "wfont_0694d6_cf4b47fcc9af483482e7689365efadb1, wf_cf4b47fcc9af483482e768936, orig_alt_riviera_light",
                        letterSpacing: "0em",
                        fontWeight: 'normal',
                        textDecoration: 'none',
                        fontSize: 'max(18px, min(22px, max(0.5px, 0.0142522 * (var(--scaling-factor) - var(--scrollbar-width)))))',
                        lineHeight: 1.2,
                      }}
                    >
                      {member.name}
                    ...
                    <p className="text-base mb-1 text-gray-600 mt-8 md:mt-16">{member.email}</p>
                    <p className="text-base text-gray-600">{member.phone}</p>
                  </div>
                </div>
      ...
      <main className="px-4 py-6 md:mt-2 mt-4">
        <div className="max-w-7xl mx-auto text-center md:mt-14">
          ...
          <p className="text-base md:text-lg mt-4 md:mt-8">Together We Do More</p>
          <p className="text-base md:text-lg px-4 md:px-0">Keller Williams Is There To Help At Every Big Step In The Realestate Journey.</p>
