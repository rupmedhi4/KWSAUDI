      ...
      <div className="relative">
        ...
        <header className={`  
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <a href="#" className="text-[15px] font-medium text-white transition-colors">About Us</a>
            <div className="w-px h-4 bg-gray-300/50 mt-1"></div>
            <a href="#" className="text-[15px] text-white transition-colors">Search</a>
            <div className="w-px h-4 bg-gray-300/50 mt-1"></div>
            <a href="#" className="text-[15px] text-white transition-colors">Join Us</a>
            <div className="w-px h-4 bg-gray-300/50 mt-1"></div>
            <a href="#" className="text-[15px] text-white transition-colors">Contact Us</a>
            <div className="w-px h-4 bg-gray-300/50 mt-1"></div>
            <a href="#" className="text-[15px] text-white transition-colors">Instant Valuation</a>

            <a href="#" className="text-[15px] text-white transition-colors">عربي</a>
            <button className="border border-white px-4 py-1.5 rounded-full text-white transition-colors text-[15px] font-medium">
              Sign In/Register
            </button>
          </nav>
          ...
          {isMenuOpen && (
            <div className={`absolute md:hidden top-full left-0 right-0 py-4 px-6 space-y-4 shadow-lg ${hasScrolled ? 'bg-gray-950/90' : 'bg-black/90'
              }`}>
